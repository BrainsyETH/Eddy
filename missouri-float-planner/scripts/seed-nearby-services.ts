...
const services: ServiceRecord[] = [
...

  {
    ...
    latitude: null,
    longitude: null,
    description: 'Outfitter serving the upper Current River area near Salem. Canoe and kayak rentals with shuttle service.',
    ...
    notes: 'Verify current operating status. May have changed hands.',
    display_order: 30,
    rivers: [
...

  {
    ...
    latitude: null,
    longitude: null,
    description: 'Outfitter at Deerleap on the lower Current River. Canoe and kayak rentals with shuttle service.',
    services_offered: ['canoe_rental', 'kayak_rental', 'shuttle'],
    seasonal_notes: null,
    nps_authorized: false,
    usfs_authorized: false,
    ...
    status: 'unverified',
    verified_source: 'knowledge_base',
    notes: 'At Deerleap. Verify if they also serve Eleven Point.',
    display_order: 97,
    rivers: [
      { slug: 'current', section_description: 'Deerleap area', is_primary: true },
    ],
  },
...

  {
    ...
    latitude: null,
    longitude: null,
    description: 'Lodging near Eminence serving Current River and Jacks Fork floaters.',
    ...
    status: 'unverified',
    verified_source: 'knowledge_base',
    notes: 'Verify current operating status, contact info, and exact location.',
    display_order: 68,
    rivers: [
      { slug: 'current', section_description: 'Eminence area', is_primary: true },
      { slug: 'jacks-fork', section_description: 'Eminence area', is_primary: false },
...

  {
    ...
    latitude: null,
    longitude: null,
    description: 'Cabins and hotel rooms on the Jacks Fork River near Eminence. Swimming, kayaking, fishing. Pet-friendly. Near Alley Spring, Rocky Falls, and Blue Spring. Formerly Rivers Edge Inn Resort.',
    services_offered: ['cabins', 'lodge_rooms'],
    seasonal_notes: null,
    nps_authorized: false,
    usfs_authorized: false,
    ...
    ownership_changed_at: null,
    status: 'active',
    verified_source: 'adventureriverresort.com',
    notes: 'Under new ownership (formerly Riversedge Resort / Rivers Edge Inn Resort).',
    display_order: 42,
    rivers: [
      { slug: 'jacks-fork', section_description: 'Eminence area', is_primary: true },
    ],
...

  {
    ...
    latitude: null,
    longitude: null,
    description: 'Cabins on 40 acres about 5 minutes south of Eminence, 2.5 miles from town and the Jacks Fork River. Built in 2021 with fireplaces and nice yards.',
    ...
    status: 'unverified',
    verified_source: 'knowledge_base',
    notes: 'Built 2021. No website found — verify current availability.',
    display_order: 48,
    rivers: [
      { slug: 'jacks-fork', section_description: 'Eminence area', is_primary: true },
    ],
...

  {
    ...
    latitude: null,
    longitude: null,
    description: 'Outfitter near Steelville on the Meramec River. Canoe, kayak, and raft rentals with shuttle service. Also offers cabins and campground.',
...

  {
    ...
    latitude: null,
    longitude: null,
    description: 'Outfitter on the Meramec River in the Sullivan area.',
    services_offered: ['canoe_rental', 'kayak_rental', 'shuttle'],
    seasonal_notes: null,
    nps_authorized: false,
    usfs_authorized: false,
    ...
    status: 'unverified',
    verified_source: 'knowledge_base',
    notes: 'Verify current operating status and all details.',
    display_order: 55,
    rivers: [
      { slug: 'meramec', section_description: 'Sullivan area', is_primary: true },
    ],
  },
...

  {
    ...
    latitude: null,
    longitude: null,
    description: 'Kayak and paddleboard outfitter on the Meramec River.',
    ...
    status: 'unverified',
    verified_source: 'knowledge_base',
    notes: 'Verify if this business exists/is operating. May be on Meramec.',
    display_order: 40,
    rivers: [
