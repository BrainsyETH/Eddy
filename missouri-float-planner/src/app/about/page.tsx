...
import { Droplets, MapPin, Clock, Gauge, TrendingUp, AlertTriangle, Info } from 'lucide-react';
import { CONDITION_COLORS, CONDITION_LABELS } from '@/constants';
import type { ConditionCode } from '@/types/api';

const conditionCodes: ConditionCode[] = ['optimal', 'low', 'very_low', 'high', 'too_low', 'dangerous', 'unknown'];
