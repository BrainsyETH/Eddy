...
const conditionStyles: Record<ConditionCode, { bg: string; border: string; text: string; icon: string; label: string }> = {
  ...
  low: { bg: 'bg-yellow-500/15', border: 'border-yellow-500/30', text: 'text-yellow-400', icon: '⚠', label: 'Low' },
  okay: { bg: 'bg-lime-500/15', border: 'border-lime-500/30', text: 'text-lime-400', icon: '✓', label: 'Okay' },
