...
const MAP_STYLES = {
  ...
  immersive: {
    name: 'Immersive',
    // Satellite imagery with luminous water veins, haloed labels, and the
    // baked layer anchors — so condition-colored rivers render over the
    // imagery exactly like on Natural. Generated by scripts/build-map-style.ts.
    url: '/map-styles/eddy-immersive.json',
    dark: true,
  },
} as const;
