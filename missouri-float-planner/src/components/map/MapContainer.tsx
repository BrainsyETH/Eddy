...
// Natural is first and default: Eddy's curated fork of OpenFreeMap Liberty
// (water-first palette, decluttered, baked layer anchors) generated by
// scripts/build-map-style.ts and served from /public.
const MAP_STYLES = {
  liberty: {
    name: 'Natural',
