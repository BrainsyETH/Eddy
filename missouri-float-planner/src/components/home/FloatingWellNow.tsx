...
// Compact "floating well now" list — live river conditions filtered to clean /
// floatable rivers. Not currently mounted: the home 2-col band now pairs Eddy's
// read with the River Map teaser. Retained for reuse.
