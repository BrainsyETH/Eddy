...
// Note: x402 AI agent payment is enforced per-route on API endpoints via withX402Route.
// Content pages (rivers, blog, gauges) are freely accessible to AI crawlers for discoverability.
