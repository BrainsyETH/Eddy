...
VALUES
  ...
  ('Running River Canoe Rental', 'running-river-canoe-rental', 'outfitter', '573-858-3214', NULL, NULL, NULL, NULL, 'Salem', 'MO', '65560', NULL, NULL, 'Outfitter serving the upper Current River area near Salem. Canoe and kayak rentals with shuttle service.', ARRAY['canoe_rental','kayak_rental','shuttle']::service_offering[], 'Seasonal — typically April through October.', FALSE, FALSE, NULL, NULL, 'unverified', 'knowledge_base', 'Verify current operating status. May have changed hands.', 30),
...
VALUES
  ...
  ('KC''s On The Current', 'kcs-on-the-current', 'outfitter', NULL, NULL, NULL, NULL, NULL, 'Deerleap', 'MO', '63935', NULL, NULL, 'Outfitter at Deerleap on the lower Current River. Canoe and kayak rentals with shuttle service.', ARRAY['canoe_rental','kayak_rental','shuttle']::service_offering[], NULL, FALSE, FALSE, NULL, NULL, 'unverified', 'knowledge_base', 'At Deerleap. Verify if they also serve Eleven Point.', 97)
...
VALUES
  ...
  ('Cobblestone Lodge', 'cobblestone-lodge', 'cabin_lodge', NULL, NULL, NULL, NULL, NULL, 'Eminence', 'MO', '65466', NULL, NULL, 'Lodging near Eminence serving Current River and Jacks Fork floaters.', ARRAY['lodge_rooms']::service_offering[], NULL, FALSE, FALSE, NULL, NULL, 'unverified', 'knowledge_base', 'Verify current operating status, contact info, and exact location.', 68)
...
VALUES
  ...
  ('Adventure River Resort', 'adventure-river-resort', 'cabin_lodge', '573-226-3233', NULL, NULL, 'https://adventureriverresort.com/', '16492 Tom Akers Road', 'Eminence', 'MO', '65466', NULL, NULL, 'Cabins and hotel rooms on the Jacks Fork River near Eminence. Swimming, kayaking, fishing. Pet-friendly. Near Alley Spring, Rocky Falls, and Blue Spring. Formerly Rivers Edge Inn Resort.', ARRAY['cabins','lodge_rooms']::service_offering[], NULL, FALSE, FALSE, NULL, NULL, 'active', 'adventureriverresort.com', 'Under new ownership (formerly Riversedge Resort / Rivers Edge Inn Resort).', 42),
  ...
  ('Hidden Ridge Cabins', 'hidden-ridge-cabins', 'cabin_lodge', '573-604-5155', NULL, NULL, NULL, NULL, 'Eminence', 'MO', '65466', NULL, NULL, 'Cabins on 40 acres about 5 minutes south of Eminence, 2.5 miles from town and the Jacks Fork River. Built in 2021 with fireplaces and nice yards.', ARRAY['cabins']::service_offering[], NULL, FALSE, FALSE, NULL, NULL, 'unverified', 'knowledge_base', 'Built 2021. No website found — verify current availability.', 48),
...
VALUES
  ...
  ('Bird''s Nest Lodge', 'birds-nest-lodge', 'outfitter', '573-775-2333', NULL, NULL, NULL, NULL, 'Steelville', 'MO', '65565', NULL, NULL, 'Outfitter near Steelville on the Meramec River. Canoe, kayak, and raft rentals with shuttle service. Also offers cabins and campground.', ARRAY['canoe_rental','kayak_rental','raft_rental','shuttle','cabins','camping_rv','camping_primitive']::service_offering[], 'Seasonal — typically April through October.', FALSE, FALSE, NULL, NULL, 'active', 'existing_codebase_migration_00068', NULL, 20),
  ...
  ('Old Cove Canoe & Kayak', 'old-cove-canoe-kayak', 'outfitter', NULL, NULL, NULL, NULL, NULL, 'Steelville', 'MO', '65565', NULL, NULL, 'Canoe and kayak outfitter on the Meramec River, offering trips on both the upper and lower sections.', ARRAY['canoe_rental','kayak_rental','shuttle']::service_offering[], NULL, FALSE, FALSE, NULL, NULL, 'unverified', 'existing_codebase_migration_00068', 'Mentioned in migration 00068 source comments. Verify all details.', 30),
  ...
  ('The Landing', 'the-landing-meramec', 'outfitter', NULL, NULL, NULL, NULL, NULL, 'Sullivan', 'MO', '63080', NULL, NULL, 'Outfitter on the Meramec River in the Sullivan area.', ARRAY['canoe_rental','kayak_rental','shuttle']::service_offering[], NULL, FALSE, FALSE, NULL, NULL, 'unverified', 'knowledge_base', 'Verify current operating status and all details.', 55),
  ...
  ('Steele River Kayaks and Boards', 'steele-river-kayaks', 'outfitter', NULL, NULL, NULL, NULL, NULL, 'Steelville', 'MO', '65565', NULL, NULL, 'Kayak and paddleboard outfitter on the Meramec River.', ARRAY['kayak_rental','shuttle']::service_offering[], NULL, FALSE, FALSE, NULL, NULL, 'unverified', 'knowledge_base', 'Verify if this business exists/is operating. May be on Meramec.', 40)
...
FROM (VALUES
  ...
  ('kcs-on-the-current', 'current', TRUE, 'Deerleap area'),
  ...
  ('cobblestone-lodge', 'current', TRUE, 'Eminence area'),
  ('cobblestone-lodge', 'jacks-fork', FALSE, 'Eminence area')
