...
VALUES
  ('Adventure Outdoors', 'adventure-outdoors', 'outfitter', '573-775-5744', NULL, NULL, 'http://adventureoutdoorcanoeing.com', '247 Thurman Lake Road', 'Steelville', 'MO', '65565', NULL, NULL, 'Upper Meramec outfitter operating near MDC Scotts Ford Access (mile 35.1). Canoe, kayak, and raft rentals with shuttle. Campground with tent sites. Camp store with supplies.', ARRAY['canoe_rental','kayak_rental','raft_rental','shuttle','camping_primitive','general_store']::service_offering[], 'Seasonal — typically April through October.', FALSE, FALSE, NULL, NULL, 'active', 'adventureoutdoorcanoeing.com, mcfa_directory, exploresteelville.com', 'Additional phone: 636-399-1122. Located near MDC Scotts Ford Access.', 22),
  ...
  ('Green''s Canoe Rental & Campground', 'greens-canoe-rental', 'outfitter', NULL, NULL, NULL, NULL, '724 West Highway 8', 'Steelville', 'MO', '65565', NULL, NULL, 'Outfitter and campground on Highway 8 near Steelville, adjacent to Woodson K. Woods Wildlife Area. Canoe rentals with shuttle on the upper Meramec. Campground with pavilion, picnic tables, fire rings, hot showers, and clean restrooms.', ARRAY['canoe_rental','shuttle','camping_primitive','showers']::service_offering[], 'Seasonal — verify current schedule.', FALSE, FALSE, NULL, NULL, 'unverified', 'yelp, go-missouri.com, campingroadtrip.com', 'Located 3 miles east of Maramec Spring Park. Adjacent to Woodson K. Woods Wildlife Area. Verify phone number and current operating status.', 23),
