...
- **Subsections** (e.g., `### Upper Current`): matched to section slugs in river-sections.ts
...
Ozarks rivers fall into two categories: **spring-fed** (Current, Eleven Point, Jacks Fork,
Big Piney, Niangua) and **rain-fed** (Meramec, Huzzah, Courtois). Spring-fed rivers maintain
...
- Sullivan gauge is the primary reference. The river at Steelville can be very different from the river at Sullivan — check access point conditions locally.
...
- Bardley gauge is the reference. Optimal is tight: 3.0-3.5 ft.
...
- The most remote of the 8 rivers — limited cell service, fewer services.
