...
/**
 * Show filters when bookable rows have a booking link or a site-photo source.
 * State Parks has exact-site photos but only park-level booking links.
 * Fully booked nights still collapse to summaries and do not need filters.
 */
